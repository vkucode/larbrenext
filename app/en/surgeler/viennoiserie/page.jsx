...
export default function Pain() {
  ...
  const filteredProducts = dataResponse.filter(product => product.tip_produs === "Surgeler" && product.categoria_produs === 'Viennoiserie');
          ...
          <div className={styles.popupContent}>
            ...
            <div className={styles.popupImg}>
              <Image
                    ...
                    width={400}
                    height={400}
                    alt={selectedProduct.nume_produs_en}
                />
